...
public class BinaryOperator extends Instruction<IntegerType> {
    ...
    public BinaryOperator(BinaryOps binaryOp, IRValue<IntegerType> operand1, IRValue<IntegerType> operand2, BasicBlock parent) {
